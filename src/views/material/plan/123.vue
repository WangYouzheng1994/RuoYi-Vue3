<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="最晚进场时间" prop="entryDeadlineDate">
        <el-date-picker clearable
          v-model="queryParams.entryDeadlineDate"
          type="date"
          value-format="YYYY-MM-DD"
          placeholder="请选择最晚进场时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="最晚进场时间" align="center" prop="entryDeadlineDate" width="180">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="detailRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="最晚进场时间" prop="entryDeadlineDate">
          <el-date-picker clearable
            v-model="form.entryDeadlineDate"
            type="date"
            value-format="YYYY-MM-DD"
            placeholder="请选择最晚进场时间">
          </el-date-picker>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除要货计划明细编号为"' + _ids + '"的数据项？').then(function() {
