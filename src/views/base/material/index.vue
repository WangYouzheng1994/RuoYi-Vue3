...
<!--      <el-form-item label="物料单位字典码" prop="materialUnitCode">
        <el-input
            v-model="queryParams.materialUnitCode"
      ...
      <el-form-item label="物料单位名称" prop="materialUnitName">
        <el-input
            v-model="queryParams.materialUnitName"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除物料基础信息编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('system/material/export', {
    ...queryParams.value
